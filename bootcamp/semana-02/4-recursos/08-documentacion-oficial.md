# 08 - Documentación Oficial y Referencias

> **Tipo**: Referencias técnicas  
...
Referencias oficiales y recursos de consulta rápida.
...
- Funciones, generics, async/await
...
- Todas las librerías estándar

**Uso**: Referencia de APIs y métodos
...
**Uso**: Encontrar widgets rápidamente
...
**Uso**: Prácticas guiadas interactivas
...
**Uso**: Widgets Cupertino y diseño iOS
...
**Uso**: Experimentar sin instalación
...
- Puntuación de calidad (pub points)
...
**Uso**: Packages confiables y mantenidos
...
**Uso**: Aprender de ejemplos reales
...
**Uso**: Diagnosticar entorno de desarrollo
...
Agrega estos a tus favoritos del navegador:
...
Revisa "See also" para alternativas
```
...
Lee README completo antes de usar
```
...
- [ ] He navegado por dart.dev
- [ ] Conozco la estructura de docs.flutter.dev
- [ ] He usado DartPad al menos una vez
- [ ] Sé buscar en API Reference
- [ ] Tengo marcadores organizados
- [ ] He explorado Widget Catalog
- [ ] Entiendo cómo leer pub.dev

---

## 🌟 Consejo del Instructor

> "La documentación oficial es tu mejor amiga. Dedica 10 minutos al día a explorar una sección que no conozcas. Con el tiempo, sabrás exactamente dónde buscar cada cosa."
...
**Anterior**: [07 - Artículos Flutter](./07-articulos-flutter.md) | **Siguiente**: [09 - Herramientas](./09-herramientas-desarrollo.md)
