# 👥 11 - Comunidades Flutter

> Comunidades para aprender, preguntar y compartir.
...
1. **Busca primero** - Probablemente ya se respondió
2. **Sé específico** - Describe el problema claramente
3. **Incluye código** - Muestra qué intentaste
4. **Comparte errores** - Copia el mensaje completo
5. **Sé amable** - La comunidad es voluntaria
