# 🎨 Assets - Semana 07: Persistencia de Datos

## 📋 Recursos Visuales

Esta carpeta contiene los recursos visuales y diagramas de la semana 07.
...
- ✅ Sombras sutiles cuando sea necesario
...
```markdown
![Arquitectura de Persistencia](./0-assets/01-arquitectura-persistencia.svg)
```
...
- Todos los SVGs están optimizados para visualización web
- Compatible con modo oscuro de GitHub
- Textos incrustados como texto (no paths) para accesibilidad
- Sin dependencias externas de fuentes

---

> 💡 **Tip**: Los SVGs se pueden editar en cualquier editor de texto o herramienta como Inkscape/Figma.
