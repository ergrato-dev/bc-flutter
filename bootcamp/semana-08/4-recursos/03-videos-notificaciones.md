# 🎬 Videos: Notificaciones en Flutter

## 📋 Contenido

Videos sobre notificaciones locales, push notifications y Firebase Cloud Messaging.
...
- ✅ Prueba en dispositivo físico (simulador tiene limitaciones)
- ✅ Configura Firebase antes de los videos de FCM
- ✅ Entiende la diferencia entre data y notification messages
- ✅ Implementa handling para todos los estados de la app
- ✅ Usa canales de notificación en Android
...
- iOS requiere provisioning profile con push capability
- Background notifications funcionan diferente en iOS
