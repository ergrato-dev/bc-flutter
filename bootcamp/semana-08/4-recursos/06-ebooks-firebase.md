# 📖 eBooks: Firebase y FCM

## 📋 Contenido

Libros y guías sobre Firebase, Firebase Cloud Messaging y servicios en la nube para Flutter.
...
└── FlutterFire Getting Started

Día 3-4: FCM
├── FCM Architecture Guide
├── Google Codelab - FCM
└── Medium - FCM Best Practices

Día 5-7: Integración
├── Firebase Cookbook (capítulos FCM)
...
- ✅ Crea un proyecto Firebase de prueba
- ✅ Sigue los codelabs paso a paso
- ✅ Prueba en dispositivos físicos
- ✅ Configura Firebase correctamente antes de codear
...
- Mantén las API keys seguras (no en repositorio público)
- Usa reglas de seguridad apropiadas en Firestore
- Implementa retry logic para FCM tokens
- Considera los límites del plan gratuito (Spark)
