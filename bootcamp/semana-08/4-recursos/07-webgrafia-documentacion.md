...
Enlaces a documentación oficial de packages y plataformas utilizados en la Semana 08.
...
| Geocoding API        | Direcciones ↔ Coordenadas | [developers.google.com/maps/documentation/geocoding](https://developers.google.com/maps/documentation/geocoding)     |
| Places API           | Búsqueda de lugares       | [developers.google.com/maps/documentation/places](https://developers.google.com/maps/documentation/places)           |
...
| Firebase Console | Administración     | [console.firebase.google.com](https://console.firebase.google.com/)                          |
...
### Configuración Rápida por Feature
...
- ✅ Usa la barra de búsqueda en pub.dev
- ✅ Revisa la sección "Example" de cada package
- ✅ Lee los "Changelog" para breaking changes
- ✅ Verifica compatibilidad de versiones
- ✅ Guarda bookmarks de la documentación frecuente
...
| ------------------------------------------ | ----------------------- | ---------------------------------------------------- |
| [eBooks Firebase](./06-ebooks-firebase.md) | [Recursos](./README.md) | [Webgrafía Tutoriales](./08-webgrafia-tutoriales.md) |
