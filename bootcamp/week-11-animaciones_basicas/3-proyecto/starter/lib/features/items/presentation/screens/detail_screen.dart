...
// Tu trabajo esta semana es completar el TODO de _DetailContent — un Hero
// que empareje con el de ItemCard (ver PASO 1 al final del archivo).
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Hero con el MISMO tag que usaste en ItemCard — ver
            // instrucciones abajo.
            const CircleAvatar(radius: 32, child: Icon(Icons.inventory_2, size: 32)),
...
// ============================================
// PASO 1: Hero (mismo tag) en el detalle
// ============================================
// Reemplaza el `CircleAvatar` de arriba por:
//
// Hero(
...
// ),
//
// El tag debe coincidir EXACTAMENTE con el de ItemCard (PASO 1 de
// item_card.dart) — mismo id, mismo prefijo `'item-icon-'`.
