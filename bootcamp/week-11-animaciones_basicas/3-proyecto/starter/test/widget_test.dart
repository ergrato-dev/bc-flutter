...
// las animaciones nuevas de esta semana (Hero/AnimatedSwitcher) — eso se
// comprueba visualmente en el emulador/simulador.
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_test/flutter_test.dart';

import 'package:domain_animations_app/app/app_router.dart';
import 'package:domain_animations_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:domain_animations_app/features/auth/domain/usecases/get_auth_token.dart';
import 'package:domain_animations_app/features/auth/domain/usecases/login.dart';
import 'package:domain_animations_app/features/auth/domain/usecases/logout.dart';
import 'package:domain_animations_app/features/auth/presentation/cubit/auth_cubit.dart';
import 'package:domain_animations_app/features/items/domain/entities/item.dart';
import 'package:domain_animations_app/features/items/domain/repositories/favorites_repository.dart';
import 'package:domain_animations_app/features/items/domain/repositories/items_repository.dart';
import 'package:domain_animations_app/features/items/domain/usecases/create_item.dart';
import 'package:domain_animations_app/features/items/domain/usecases/get_favorite_ids.dart';
import 'package:domain_animations_app/features/items/domain/usecases/get_items.dart';
import 'package:domain_animations_app/features/items/domain/usecases/toggle_favorite.dart';
import 'package:domain_animations_app/features/items/presentation/cubit/create_item_cubit.dart';
import 'package:domain_animations_app/features/items/presentation/cubit/favorites_cubit.dart';
import 'package:domain_animations_app/features/items/presentation/cubit/items_cubit.dart';
