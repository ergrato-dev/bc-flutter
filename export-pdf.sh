...
echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BOLD}${BLUE}  📄 Exportador PDF - Bootcamp Flutter${NC}"
echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
# Orden: README, rúbrica, teoría (01,02...), prácticas, proyecto, glosario
mapfile -t MD_FILES < <(
...
if [[ "$MERGE" == "--merge" ]]; then
  ...
  {
    echo "---"
    echo "title: Bootcamp Flutter - $(echo "$WEEK" | sed 's/-/ /g' | tr '[:lower:]' '[:upper:]')"
    echo "date: $(date '+%B %Y')"
    echo "---"
    echo ""
  } > "$TEMP_MERGED"
